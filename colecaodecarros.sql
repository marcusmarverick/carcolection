...
insert into colecaodecarros values ('LTH6154', 'chargedaytona', 1960, 'Dogde', 'estadosunidos', 'corrida');
...
insert into colecaodecarros values ('LLK4243', 'senna', 2019, 'mclaren', 'reinounido', 'corrida');
...
insert into colecaodecarros values ('KWM2393', 'lancerevolutionVIII', 2007, 'mitsubishi', 'japao', 'corrida'); 
insert into colecaodecarros values ('LNS7863', 'NSX', 2006, 'honda', 'japao', 'corrida');
insert into colecaodecarros values ('KNC0755', 'civictyper', 2002, 'nissan', 'japao', 'corrida'); 
